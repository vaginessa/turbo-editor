...
public class Data<DATATYPE extends Data<DATATYPE>> extends BasicContainer {
    ...
    public static interface DataSorting {
         ...
         *
         * @param input One line of the data array
         */
     ...
     *
     * @param lines An array representing the lines of the data
     */
     ...
     *
     * @param contains The pattern which the line should contain
     * @param newLine  The new line that should be used as a replacement
     * @return This instance
     */
     ...
     *
     * @param contains A string to locate within each line to determine whether or not to remove the line
     * @return This instance
     */
    ...
    /**
     * @return The last non-empty line of the data array
     */
     ...
     *
     * @param aLineNumber The line number to return
     * @param aSkipEmpty  Whether or not to include empty lines
